"""
Django settings for realpal project.
...
THIRD_PARTY_APPS = [
    ...
    'allauth',  # onboarding
    'allauth.account',  # onboarding
    'allauth.socialaccount',  # onboarding
    'widget_tweaks'
]
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'realpal.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Harish Maiya""", 'baysideyardparties@gmail.com'),
]
